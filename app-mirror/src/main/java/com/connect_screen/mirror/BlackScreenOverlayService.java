...
public class BlackScreenOverlayService extends Service {
    ...
    public static void show(Context context) {
        ...
        context.startService(new Intent(context, BlackScreenOverlayService.class));
    }
    ...
    private void showOverlay() {
        ...
        Display defaultDisplay = baseWindowManager.getDefaultDisplay();
        Context displayContext = createDisplayContext(defaultDisplay);
        ...
        try {
            ...
            State.log("[BlackScreenOverlay] shown on default display");
        } catch (Throwable e) {
            blackView = null;
